...
\begin{frame}[fragile]
  \lstinputlisting[basicstyle=\style{\tiny}]{code/long-seps.py}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \vspace{1.5cm}
  \lstinputlisting{code/read-no-return.py}
\end{frame}
...
\begin{frame}[fragile]
  \lstinputlisting{code/functions-seps-comments.py}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \lstinputlisting{code/homework.py}
\end{frame}
